package de.bht.fpa.mail.s000000.common.rcp.exception;
...
public class ExceptionDetailsErrorDialog extends IconAndMessageDialog {
   ...
   * contains child items <it>and </it> you need to specify a mask which will be
   ...
   * @param dialogTitle
   *          the title to use for this dialog, or <code>null</code> to indicate
   *          that the default title should be used
   * @param message
   *          the message to show in this dialog, or <code>null</code> to
   *          indicate that the error's message should be shown as the primary
   *          message
   * @param status
   ...
   *         button was pressed, or <code>Dialog.CANCEL</code> if this dialog's
   *         close window decoration or the ESC key was used.
   */
   ...
   * @param includeStatus
   *          whether to include the buildingStatus in the display or just its
   *          children
   */
   ...
   * has been invoked and has returned the control for the content area of the
   * dialog. Invoking the method before the content area has been set or after
